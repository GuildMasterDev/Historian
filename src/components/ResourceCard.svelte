...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 overflow-hidden border border-gray-200 dark:border-gray-700">
  {#if resource.thumbnail}
    <div class="h-32 bg-linear-to-br from-indigo-400 to-purple-500 relative">
      <img 
  ...
  {:else}
    <div class="h-32 bg-linear-to-br from-indigo-400 to-purple-500 flex items-center justify-center">
